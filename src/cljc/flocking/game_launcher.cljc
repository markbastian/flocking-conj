...
(defn setup []
  ...
  {:world { :minx -10 :maxx 10 :miny -10 :maxy 10 }
   :boids [{:width 0.6 :height 1.0 :state [0 0 0 0] :behaviors { :wander { :wander-direction 0.0 :wander-rate 0.6 :wander-strength 1.0 } }}
           {:width 0.6 :height 1.0 :state [0 0 0 0] :behaviors { :wander { :wander-direction 0.0 :wander-rate 0.6 :wander-strength 1.0 } }}
           {:width 0.6 :height 1.0 :state [0 0 0 0] :behaviors { :wander { :wander-direction 0.0 :wander-rate 0.6 :wander-strength 1.0 } }}
           {:width 0.6 :height 1.0 :state [0 0 0 0] :behaviors { :wander { :wander-direction 0.0 :wander-rate 0.6 :wander-strength 1.0 } }}
           {:width 0.6 :height 1.0 :state [0 0 0 0] :behaviors { :wander { :wander-direction 0.0 :wander-rate 0.6 :wander-strength 1.0 } }}]})
